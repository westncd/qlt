...
void login(){
    ...
    ifstream taikhoan("C:\\Users\\Administrator\\Desktop\\taikhoanmatkhau\\username.txt", ios :: in);
    ifstream password("C:\\Users\\Administrator\\Desktop\\taikhoanmatkhau\\password.txt", ios :: in);
    taikhoan >> tk[0];
    password >> mk[0];
    ...
    taikhoan.close();
    ifstream account("C:\\Users\\Administrator\\Desktop\\taikhoanmatkhau\\username.txt", ios :: in);
    account >> tk[0];
    while(!account.eof()){
        getline(account, acc);
...
void signup(){
    ...
    ifstream taikhoan("C:\\Users\\Administrator\\Desktop\\taikhoanmatkhau\\username.txt", ios :: in);
    ifstream matkhau("C:\\Users\\Administrator\\Desktop\\taikhoanmatkhau\\username.txt", ios :: in);

    ofstream username("C:\\Users\\Administrator\\Desktop\\taikhoanmatkhau\\username.txt", ios :: app); 
    ofstream password("C:\\Users\\Administrator\\Desktop\\taikhoanmatkhau\\password.txt", ios :: app);
